...
def precipitation():
    ...
    prev_last_date).order_by(Measurement.date.desc()).all()

# Step 3. '/api/v1.0/stations'
...
# Step 5. '/api/v1.0/<start>' and '/api/v1.0/<start>/<end>'
